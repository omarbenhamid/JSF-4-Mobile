...
/**
 * <p>
 *      JavaScript renderer for javascript.
 * </p>
 *
 * <p>
 *      javascript code should be written in an extern es file.
 ...
 * @version 1.0
 */
public class JavaScriptRenderer implements ScriptRenderer {
    ...
    public String encodeScriptHead(FacesContext context, UIComponent component) {
        ...
        String src = (String) component.getAttributes().get("SCRIPT_SRC") + ".js";
        ...
        if (writer != null && src != null) {
            ...
            try {
                writer.startElement(LangConstant.TAG_SCRIPT, component);
                writer.writeAttribute(LangConstant.ATT_TYPE, TYPE, "type");
                writer.writeAttribute(LangConstant.ATT_LANGUAGE, LangConstant.JAVASCRIPT, "language");
                writer.writeAttribute(LangConstant.ATT_SRC, src , "src");
                writer.endElement(LangConstant.TAG_SCRIPT);
            } catch (IOException ex) {
                Log.err("Failed to write script tag!", JavaScriptRenderer.class);
                Log.err(ex, JavaScriptRenderer.class);
            }
        }
        return null;
    }
        ...
        for (int i=0; i<scriptAttributes.length; i++) {
            ...
            if (value != null && !value.equals("") && !RenderUtils.isDefaultValue(value)) {
                try {
                    ...
                    Log.err("Failed to write script attribute!", JavaScriptRenderer.class);
                    Log.err(ex, JavaScriptRenderer.class);
                }
            }
        }
    ...
    // script type
    private final static String TYPE = "text/javascript";
}
