...
/**
 * <p>
 *      H5Tag is a JSF UIComponentTag for generating heading body tag like <h5>.
 ...
 * @version 1.1
 */
public class H5Tag extends UIComponentELTag {
    ...
    public void setProperties(UIComponent component) {
        ...
        component.getAttributes().put(TagConstant.COMPONENT_ATTR_HEADING,
            TagConstant.COMPONENT_ATTR_HEADING_NO[5]);
