...
/**
 * <p>
 *      TitleTag is a JSF UIComponentTag for
 *      generating the title element in HTML/XHTML-MP.
 *      In WML page, it will be rendered as a meta element.
 * </p>
 *
 ...
 * @version 1.0
 */
public class TitleTag extends UIComponentELTag {
    ...
    public String getRendererType() {
        return TagConstant.RENDERER_TYPE_TITLE;
    }
    ...
    public void setProperties(UIComponent component) {
        ...
        component.setValueExpression(LangConstant.ATT_CONTENT, content);
    }
}
