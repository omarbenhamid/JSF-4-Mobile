...
/**
 * <p>
 *      H2Tag is a JSF UIComponentTag for generating heading body tag like <h2>.
 ...
 * @version 1.1
 */
public class H2Tag extends UIComponentELTag {
    ...
    public void setProperties(UIComponent component) {
        ...
        component.getAttributes().put(TagConstant.COMPONENT_ATTR_HEADING,
            TagConstant.COMPONENT_ATTR_HEADING_NO[2]);
