...
/**
 * <p>
 *      H3Tag is a JSF UIComponentTag for generating heading body tag like <h3>.
 ...
 * @version 1.1
 */
public class H3Tag extends UIComponentELTag {
    ...
    public void setProperties(UIComponent component) {
        ...
        component.getAttributes().put(TagConstant.COMPONENT_ATTR_HEADING,
            TagConstant.COMPONENT_ATTR_HEADING_NO[3]);
