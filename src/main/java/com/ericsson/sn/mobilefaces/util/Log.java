...
/**
 * <p>
 * Log facade to show message and record the error information.
 * </p>
 * 
 * 
 * <p>
...
public class Log {
	...
	/**
	 * <p>
	 * Set flag to show debug message or not.
	 * </p>
	 * 
	 * @param isDebug
	...
	/**
	 * <p>
	 * Print out the key message with the highest priority.
	 * </p>
	 * 
	 * @param master
	 *            master class for tracking
	 * @param msg
	 *            message
	 */
	...
	/**
	 * <p>
	 * Print out the error message with the higher priority.
	 * </p>
	 * 
	 * @param master
	 *            master class for tracking
	...
	/**
	 * <p>
	 * Print out the information message with the normal priority.
	 * </p>
	 * 
	 * @param master
	 *            master class for tracking
	...
	/**
	 * <p>
	 * Print out the debug message with the low priority. It will not be
	 * displayed in default JRE setting.
	 * </p>
	 * 
	 * @param master
	 *            master class for tracking
	...
	public static void debug(Object msg, Class master) {
		if (debug) {
			System.err.println("==MobileFaces Debug :  [" + master.getName()
					+ "]" + msg);
		}
	}
	...
	/**
	 * <p>
	 * Estimate the condition expression is true. If false, throw out the
	 * warning.
	 * </p>
	 * 
	...
	public static boolean doAssert(boolean condition, String msg, Class master) {
		if (!condition) {
			System.err.println("==MobileFaces False Condition Found in "
					+ master.getName());
			System.err.println(msg.toString());
		}
		return condition;
	...
	/**
	 * <p>
	 * Estimate the object is not null. If null, throw out the warning.
	 * </p>
	 * 
	 ...
	 *            master class for tracking
	 * @param object
	 *            object need be checked
	 * @param msg
	 *            warning message
	 */
	public static boolean doAssert(Object object, String msg, Class master) {
		if (object == null) {
			System.err.println("==MobileFaces Null Object Found in "
					+ master.getName());
			System.err.println(msg.toString());
			return false;
		} else {
