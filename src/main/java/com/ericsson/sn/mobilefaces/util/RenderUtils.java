...
public class RenderUtils {
    ...
    /**
     * <p>Get the string array by parseing a long string.</p>
     * <p>For example:<br/>
    ...
    /**
     * <p>Check the value is default or not.</p>
     * @param value value is an instance of a wrapper
    ...
    public static boolean isDefaultValue(Object value) {
        ...
        if (value instanceof Boolean && (Boolean)value == Boolean.FALSE.booleanValue()) {
            return true;
        } else if (value instanceof Double && (Double)value == Double.MIN_VALUE) {
            return true;
        } else if (value instanceof Integer && (Integer)value == Integer.MIN_VALUE) {
            return true;
        } else if (value instanceof Character && (Character)value == Character.MIN_VALUE) {
            return true;
    ...
    /**
     * <p>Get a convertor for current component.
     * If component is a Value Holder, just return
     * the convertor from Holder. Else create a
     * Convertor from valuebinding or value.</p>
     * @param context FacesContext
     * @param component component to get convertor
     * @param value the value to be converted
     * @param fromValueBinding generate convertor from value binding or value
     * @return the generated convertor
     */
    public static Converter getConvertor(FacesContext context, UIComponent component,
            Object value, boolean fromValueBinding) {
