...
/**
 * <p>
 *      MessagesRenderer is a renderer to render message group item on XHTML-MP page.
 * </p>
 *
 * <p>Company:   Ericsson AB</p>
 *
 * @jsf.render-kit  component-family="javax.faces.Messages"
 *                  renderer-type="javax.faces.Messages"
 *                  description="MessagesRenderer is the renderer for a message group item on XHTML-MP page"
 *
 * @author Daning Yang
 * @version 1.0
 */
public class MessagesRenderer extends BasicMessageRenderer{
    ...
    /**
     * <p>this is a multi message item.</p>
     * @return true
     */
    @Override
