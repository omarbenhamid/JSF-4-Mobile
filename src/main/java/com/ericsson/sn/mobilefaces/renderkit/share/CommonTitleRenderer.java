...
/**
 * <p>
 *      CommonTitleRenderer is a JSF renderer for creating the title element for
 *      HTML/XHTML-MP.
 * </p>
 *
 ...
 *                  description="CommonTitleRenderer is the renderer for title (inside head)."
 *
 *
 * 
 * @version 1.0
 */
public class CommonTitleRenderer extends BasicRenderer {

    /**
     * <p>Generate instance and initialize with markup language type.</p>
     */
    public CommonTitleRenderer() {
    ...
    throws IOException {
        ...
        writer.startElement(LangConstant.TAG_TITLE, component);
        writer.write(content);
        writer.endElement(LangConstant.TAG_TITLE);
    }
}
