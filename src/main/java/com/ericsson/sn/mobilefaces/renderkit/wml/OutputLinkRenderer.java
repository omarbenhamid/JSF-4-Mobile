 ...
 *                  description="OutputLinkRenderer is the renderer for a simple link on WML page"
 *
 * @author Daning Yang
 * @version 1.1
 */
public class OutputLinkRenderer extends BasicInputRenderer {
    ...
    throws IOException {
        ...
        // encode all children components
