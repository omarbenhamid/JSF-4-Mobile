 ...
 *      as a hidden field of form on WML page.
 * </p>
 *
 * <p>
 *      This HiddenRenderer just add the value pair to the FormValueHolder.
 * </p>
 *
 ...
 *                  description="HiddenRenderer is the renderer for a hidden field on WML page"
 *
 * @author Daning Yang
 * @version 1.0
 */
public class HiddenRenderer extends BasicInputRenderer {
    ...
    throws IOException{
        ...
        getFormValueHolder(context,component).setFormValue(clientId, value);
    }
}
