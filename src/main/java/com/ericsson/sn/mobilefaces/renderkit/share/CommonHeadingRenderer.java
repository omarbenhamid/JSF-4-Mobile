...
/**
 * <p>
 *      CommonHeadingRenderer is a JSF renderer for
 *      generating common heading tag from &lt;h1&gt; to &lt;h6&gt;.
 * </p>
 *
 ...
 *                  description="CommonHeadingRenderer is the renderer for heading tag on HTML/XHTML-MP page"
 * @author Daning Yang
 * 
 * @version 1.1
 */
public class CommonHeadingRenderer extends BasicRenderer {

    /**
     * <p>Generate instance and initialize with markup language type.</p>
     */
    public CommonHeadingRenderer() {
    ...
    throws IOException {
        ...
        String hltag = "h" + (String) component.getAttributes().get("HEADING");
        writer.startElement(hltag, component);
