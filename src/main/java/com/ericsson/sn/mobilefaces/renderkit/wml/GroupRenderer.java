 ...
 *      as group set on WML page.
 * </p>
 *
 * <p>
 *      This GroupRenderer groups a set of content
 *      with &lt;fieldset&gt tag.
 * </p>
 *
 ...
 *                  description="GroupRenderer is the renderer for a group for content on WML page"
 *
 * @author Daning Yang
 * @version 1.0
 */
...
//        // write <fieldset>
//        writer.startElement(lang.TAG_FIELDSET, component);
//        String id = getPartID(component.getClientId(context));
//        writer.writeAttribute(lang.ATT_TITLE, id, "title");
    }
    ...
    throws IOException {
        ...
        ResponseWriter writer = context.getResponseWriter();
//        // write </fieldset>
//        writer.endElement(lang.TAG_FIELDSET);
    }

    // get the component name part in the id
    private String getPartID(String id) {
        if (id.indexOf(":")!=-1)
