...
/**
 * <p>
 * MobileRenderKitFactory is an implementation of RenderKitFactory for
 * generating RenderKit for mobile devices based on
 * {@link com.ericsson.sn.mobilefaces.device.DeviceData} feature.
 * </p>
 * 
 * <p>
 * MobileRenderKitFactory contains HTML_BASIC/XHTML-MP/WML renderkits for mobile
 * device. New renderkits can be defined in faces-config as standard JSF custom
 * renderkit.
 * </p>
 * 
 * <p>
...
public class MobileRenderKitFactory extends RenderKitFactory {
	...
	/**
	 * <p>
	 * Initialize renderkit pool and default HTML renderkit.
	 * </p>
	 */
	...
	public void addRenderKit(String renderKitId, RenderKit renderKit) {
		synchronized (renderKits) {
			Log.debug("Add renderkit: " + renderKitId,
					MobileRenderKitFactory.class);
	...
	/**
	 * <p>
	 * Get renderkit from pool based on current device support markup language.
	 * </p>
	 * 
	 * @param context
	 *            FacesContext to get device feature
	 * @param renderKitId
	...
	public RenderKit getRenderKit(FacesContext context, String renderKitId) {
		...
		if (context != null)
			Log.doAssert(renderKit, "Cannot find renderkit " + renderKitId,
					MobileRenderKitFactory.class);
	...
	/**
	 * <p>
	 * Get iterator for all renderkits in the pool.
	 * </p>
	 * 
